...
class TestMathGame(unittest.TestCase):
    ...
    def test_get_random_int(self):
        """
           Unit test of random numbers generated are within the specified range
        """
        min_val = 1
        max_val = 10
    ...
    def test_get_random_math_operator(self):
        """
            Unit test generated operator is in [+,-,*] container or not.
        """
        for _ in range(1000):
    ...
    def test_get_result(self):
        """
                set test_cases array.
                Unit test of get_result function
        """
        test_cases = [
            (5, 2, '+', '5 + 2', 7),
            (6, 4, '-', '6 - 4', 2),
